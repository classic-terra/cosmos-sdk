...
var (
	md_SimulateSpecialRequest          protoreflect.MessageDescriptor
	fd_SimulateSpecialRequest_tx       protoreflect.FieldDescriptor
	fd_SimulateSpecialRequest_tx_bytes protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_tx_v1beta1_service_proto_init()
	md_SimulateSpecialRequest = File_cosmos_tx_v1beta1_service_proto.Messages().ByName("SimulateSpecialRequest")
	fd_SimulateSpecialRequest_tx = md_SimulateSpecialRequest.Fields().ByName("tx")
	fd_SimulateSpecialRequest_tx_bytes = md_SimulateSpecialRequest.Fields().ByName("tx_bytes")
}

var _ protoreflect.Message = (*fastReflection_SimulateSpecialRequest)(nil)

type fastReflection_SimulateSpecialRequest SimulateSpecialRequest

func (x *SimulateSpecialRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SimulateSpecialRequest)(x)
}

func (x *SimulateSpecialRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_SimulateSpecialRequest_messageType fastReflection_SimulateSpecialRequest_messageType
var _ protoreflect.MessageType = fastReflection_SimulateSpecialRequest_messageType{}

type fastReflection_SimulateSpecialRequest_messageType struct{}

func (x fastReflection_SimulateSpecialRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SimulateSpecialRequest)(nil)
}
func (x fastReflection_SimulateSpecialRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_SimulateSpecialRequest)
}
func (x fastReflection_SimulateSpecialRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SimulateSpecialRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SimulateSpecialRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_SimulateSpecialRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SimulateSpecialRequest) Type() protoreflect.MessageType {
	return _fastReflection_SimulateSpecialRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SimulateSpecialRequest) New() protoreflect.Message {
	return new(fastReflection_SimulateSpecialRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SimulateSpecialRequest) Interface() protoreflect.ProtoMessage {
	return (*SimulateSpecialRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SimulateSpecialRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Tx != nil {
		value := protoreflect.ValueOfMessage(x.Tx.ProtoReflect())
		if !f(fd_SimulateSpecialRequest_tx, value) {
			return
		}
	}
	if len(x.TxBytes) != 0 {
		value := protoreflect.ValueOfBytes(x.TxBytes)
		if !f(fd_SimulateSpecialRequest_tx_bytes, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SimulateSpecialRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		return x.Tx != nil
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx_bytes":
		return len(x.TxBytes) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateSpecialRequest"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.SimulateSpecialRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		x.Tx = nil
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx_bytes":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SimulateSpecialRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		value := x.Tx
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.v1beta1.SimulateSpecialRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		x.Tx = value.Message().Interface().(*Tx)
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx_bytes":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		if x.Tx == nil {
			x.Tx = new(Tx)
		...
		return protoreflect.ValueOfMessage(x.Tx.ProtoReflect())
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx_bytes":
		panic(fmt.Errorf("field tx_bytes of message cosmos.tx.v1beta1.SimulateSpecialRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateSpecialRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SimulateSpecialRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialRequest.tx":
		m := new(Tx)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SimulateSpecialRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.SimulateSpecialRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SimulateSpecialRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SimulateSpecialRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SimulateSpecialRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SimulateSpecialRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SimulateSpecialRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SimulateSpecialRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_SimulateSpecialResponse          protoreflect.MessageDescriptor
	fd_SimulateSpecialResponse_gas_info protoreflect.FieldDescriptor
	fd_SimulateSpecialResponse_result   protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_tx_v1beta1_service_proto_init()
	md_SimulateSpecialResponse = File_cosmos_tx_v1beta1_service_proto.Messages().ByName("SimulateSpecialResponse")
	fd_SimulateSpecialResponse_gas_info = md_SimulateSpecialResponse.Fields().ByName("gas_info")
	fd_SimulateSpecialResponse_result = md_SimulateSpecialResponse.Fields().ByName("result")
}

var _ protoreflect.Message = (*fastReflection_SimulateSpecialResponse)(nil)

type fastReflection_SimulateSpecialResponse SimulateSpecialResponse

func (x *SimulateSpecialResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SimulateSpecialResponse)(x)
}

func (x *SimulateSpecialResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_SimulateSpecialResponse_messageType fastReflection_SimulateSpecialResponse_messageType
var _ protoreflect.MessageType = fastReflection_SimulateSpecialResponse_messageType{}

type fastReflection_SimulateSpecialResponse_messageType struct{}

func (x fastReflection_SimulateSpecialResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SimulateSpecialResponse)(nil)
}
func (x fastReflection_SimulateSpecialResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_SimulateSpecialResponse)
}
func (x fastReflection_SimulateSpecialResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SimulateSpecialResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SimulateSpecialResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_SimulateSpecialResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SimulateSpecialResponse) Type() protoreflect.MessageType {
	return _fastReflection_SimulateSpecialResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SimulateSpecialResponse) New() protoreflect.Message {
	return new(fastReflection_SimulateSpecialResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SimulateSpecialResponse) Interface() protoreflect.ProtoMessage {
	return (*SimulateSpecialResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SimulateSpecialResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.GasInfo != nil {
		value := protoreflect.ValueOfMessage(x.GasInfo.ProtoReflect())
		if !f(fd_SimulateSpecialResponse_gas_info, value) {
			return
		}
	}
	if x.Result != nil {
		value := protoreflect.ValueOfMessage(x.Result.ProtoReflect())
		if !f(fd_SimulateSpecialResponse_result, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SimulateSpecialResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		return x.GasInfo != nil
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.result":
		return x.Result != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.tx.v1beta1.SimulateSpecialResponse"))
		}
		panic(fmt.Errorf("message cosmos.tx.v1beta1.SimulateSpecialResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		x.GasInfo = nil
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.result":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SimulateSpecialResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		value := x.GasInfo
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.tx.v1beta1.SimulateSpecialResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		x.GasInfo = value.Message().Interface().(*v1beta11.GasInfo)
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.result":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		if x.GasInfo == nil {
			x.GasInfo = new(v1beta11.GasInfo)
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SimulateSpecialResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info":
		m := new(v1beta11.GasInfo)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SimulateSpecialResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.tx.v1beta1.SimulateSpecialResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SimulateSpecialResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SimulateSpecialResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SimulateSpecialResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SimulateSpecialResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SimulateSpecialResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SimulateSpecialResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SimulateSpecialResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// SimulateSpecialRequest is the request type for the Service.SimulateSpecial
// RPC method.
type SimulateSpecialRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SimulateSpecialRequest) Reset() {
	*x = SimulateSpecialRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *SimulateSpecialRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimulateSpecialRequest) ProtoMessage() {}

// Deprecated: Use SimulateSpecialRequest.ProtoReflect.Descriptor instead.
func (*SimulateSpecialRequest) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{6}
}

// Deprecated: Do not use.
func (x *SimulateSpecialRequest) GetTx() *Tx {
	if x != nil {
		return x.Tx
	}
	return nil
...
func (x *SimulateSpecialRequest) GetTxBytes() []byte {
	if x != nil {
		return x.TxBytes
	}
	return nil
...
// SimulateSpecialResponse is the response type for the
// Service.SimulateSpecial RPC method.
type SimulateSpecialResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SimulateSpecialResponse) Reset() {
	*x = SimulateSpecialResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_tx_v1beta1_service_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *SimulateSpecialResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimulateSpecialResponse) ProtoMessage() {}

// Deprecated: Use SimulateSpecialResponse.ProtoReflect.Descriptor instead.
func (*SimulateSpecialResponse) Descriptor() ([]byte, []int) {
	return file_cosmos_tx_v1beta1_service_proto_rawDescGZIP(), []int{7}
}

func (x *SimulateSpecialResponse) GetGasInfo() *v1beta11.GasInfo {
	if x != nil {
		return x.GasInfo
	}
	return nil
...
func (x *SimulateSpecialResponse) GetResult() *v1beta11.Result {
	if x != nil {
		return x.Result
	}
	return nil
...
var file_cosmos_tx_v1beta1_service_proto_rawDesc = []byte{
	...
	0x5e, 0x0a, 0x16, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x53, 0x70, 0x65, 0x63, 0x69,
	0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x02, 0x74, 0x78, 0x18,
	...
	0x91, 0x01, 0x0a, 0x17, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x53, 0x70, 0x65, 0x63,
	0x69, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x08, 0x67,
	...
	0x75, 0x6c, 0x74, 0x22, 0x22, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x54, 0x78, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x7d, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x54, 0x78,
	...
	0x45, 0x0a, 0x0b, 0x74, 0x78, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x02,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x78, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f,
	...
	0x22, 0xf0, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74,
	0x68, 0x54, 0x78, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x03,
	...
	0x6f, 0x63, 0x6b, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x47, 0x0a, 0x0a, 0x70, 0x61,
	0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27,
	0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x71, 0x75, 0x65,
	0x72, 0x79, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x65, 0x52,
	...
	0x73, 0x22, 0x39, 0x0a, 0x10, 0x54, 0x78, 0x44, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73,
	...
	0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x78, 0x52, 0x02, 0x74, 0x78, 0x22, 0x38, 0x0a, 0x0f,
	0x54, 0x78, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
	...
	0x5f, 0x41, 0x53, 0x59, 0x4e, 0x43, 0x10, 0x03, 0x32, 0xc5, 0x0a, 0x0a, 0x07, 0x53, 0x65, 0x72,
	...
	,
	...
	0x12, 0x1d, 0x2f, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x74, 0x78, 0x2f, 0x76, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0x2f, 0x74, 0x78, 0x73, 0x2f, 0x7b, 0x68, 0x61, 0x73, 0x68, 0x7d, 0x12,
	0x7f, 0x0a, 0x0b, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x54, 0x78, 0x12, 0x25,
	...
	0x12, 0x7c, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x54, 0x78, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	,
	...
	0x7b, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x7d, 0x12, 0x79, 0x0a, 0x08, 0x54, 0x78, 0x44, 0x65,
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x22, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78,
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x54, 0x78, 0x44, 0x65, 0x63, 0x6f, 0x64,
	...
	0x65, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x24, 0x82,
	...
	0x6f, 0x64, 0x65, 0x12, 0x79, 0x0a, 0x08, 0x54, 0x78, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x12,
	0x22, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x62, 0x65,
	0x74, 0x61, 0x31, 0x2e, 0x54, 0x78, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x8e,
	0x01, 0x0a, 0x0d, 0x54, 0x78, 0x45, 0x6e, 0x63, 0x6f, 0x64, 0x65, 0x41, 0x6d, 0x69, 0x6e, 0x6f,
	...
	0x8e, 0x01, 0x0a, 0x0d, 0x54, 0x78, 0x44, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x41, 0x6d, 0x69, 0x6e,
	...
	0x74, 0x61, 0x31, 0x2f, 0x64, 0x65, 0x63, 0x6f, 0x64, 0x65, 0x2f, 0x61, 0x6d, 0x69, 0x6e, 0x6f,
...
var file_cosmos_tx_v1beta1_service_proto_goTypes = []interface{}{
	...
	(*SimulateSpecialRequest)(nil),  // 8: cosmos.tx.v1beta1.SimulateSpecialRequest
	(*SimulateSpecialResponse)(nil), // 9: cosmos.tx.v1beta1.SimulateSpecialResponse
	(*GetTxRequest)(nil),            // 10: cosmos.tx.v1beta1.GetTxRequest
	(*GetTxResponse)(nil),           // 11: cosmos.tx.v1beta1.GetTxResponse
...
var file_cosmos_tx_v1beta1_service_proto_depIdxs = []int32{
	...
	23, // 10: cosmos.tx.v1beta1.SimulateSpecialRequest.tx:type_name -> cosmos.tx.v1beta1.Tx
	26, // 11: cosmos.tx.v1beta1.SimulateSpecialResponse.gas_info:type_name -> cosmos.base.abci.v1beta1.GasInfo
	27, // 12: cosmos.tx.v1beta1.SimulateSpecialResponse.result:type_name -> cosmos.base.abci.v1beta1.Result
	23, // 13: cosmos.tx.v1beta1.GetTxResponse.tx:type_name -> cosmos.tx.v1beta1.Tx
	24, // 14: cosmos.tx.v1beta1.GetTxResponse.tx_response:type_name -> cosmos.base.abci.v1beta1.TxResponse
	22, // 15: cosmos.tx.v1beta1.GetBlockWithTxsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	23, // 16: cosmos.tx.v1beta1.GetBlockWithTxsResponse.txs:type_name -> cosmos.tx.v1beta1.Tx
	28, // 17: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block_id:type_name -> tendermint.types.BlockID
	29, // 18: cosmos.tx.v1beta1.GetBlockWithTxsResponse.block:type_name -> tendermint.types.Block
	25, // 19: cosmos.tx.v1beta1.GetBlockWithTxsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	23, // 20: cosmos.tx.v1beta1.TxDecodeResponse.tx:type_name -> cosmos.tx.v1beta1.Tx
	23, // 21: cosmos.tx.v1beta1.TxEncodeRequest.tx:type_name -> cosmos.tx.v1beta1.Tx
	6,  // 22: cosmos.tx.v1beta1.Service.Simulate:input_type -> cosmos.tx.v1beta1.SimulateRequest
	8,  // 23: cosmos.tx.v1beta1.Service.SimulateSpecial:input_type -> cosmos.tx.v1beta1.SimulateSpecialRequest
	10, // 24: cosmos.tx.v1beta1.Service.GetTx:input_type -> cosmos.tx.v1beta1.GetTxRequest
	4,  // 25: cosmos.tx.v1beta1.Service.BroadcastTx:input_type -> cosmos.tx.v1beta1.BroadcastTxRequest
	2,  // 26: cosmos.tx.v1beta1.Service.GetTxsEvent:input_type -> cosmos.tx.v1beta1.GetTxsEventRequest
	12, // 27: cosmos.tx.v1beta1.Service.GetBlockWithTxs:input_type -> cosmos.tx.v1beta1.GetBlockWithTxsRequest
	14, // 28: cosmos.tx.v1beta1.Service.TxDecode:input_type -> cosmos.tx.v1beta1.TxDecodeRequest
	16, // 29: cosmos.tx.v1beta1.Service.TxEncode:input_type -> cosmos.tx.v1beta1.TxEncodeRequest
	18, // 30: cosmos.tx.v1beta1.Service.TxEncodeAmino:input_type -> cosmos.tx.v1beta1.TxEncodeAminoRequest
	20, // 31: cosmos.tx.v1beta1.Service.TxDecodeAmino:input_type -> cosmos.tx.v1beta1.TxDecodeAminoRequest
	7,  // 32: cosmos.tx.v1beta1.Service.Simulate:output_type -> cosmos.tx.v1beta1.SimulateResponse
	9,  // 33: cosmos.tx.v1beta1.Service.SimulateSpecial:output_type -> cosmos.tx.v1beta1.SimulateSpecialResponse
	11, // 34: cosmos.tx.v1beta1.Service.GetTx:output_type -> cosmos.tx.v1beta1.GetTxResponse
	5,  // 35: cosmos.tx.v1beta1.Service.BroadcastTx:output_type -> cosmos.tx.v1beta1.BroadcastTxResponse
	3,  // 36: cosmos.tx.v1beta1.Service.GetTxsEvent:output_type -> cosmos.tx.v1beta1.GetTxsEventResponse
	13, // 37: cosmos.tx.v1beta1.Service.GetBlockWithTxs:output_type -> cosmos.tx.v1beta1.GetBlockWithTxsResponse
	15, // 38: cosmos.tx.v1beta1.Service.TxDecode:output_type -> cosmos.tx.v1beta1.TxDecodeResponse
	17, // 39: cosmos.tx.v1beta1.Service.TxEncode:output_type -> cosmos.tx.v1beta1.TxEncodeResponse
	19, // 40: cosmos.tx.v1beta1.Service.TxEncodeAmino:output_type -> cosmos.tx.v1beta1.TxEncodeAminoResponse
	21, // 41: cosmos.tx.v1beta1.Service.TxDecodeAmino:output_type -> cosmos.tx.v1beta1.TxDecodeAminoResponse
...
func file_cosmos_tx_v1beta1_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_tx_v1beta1_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SimulateSpecialRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_cosmos_tx_v1beta1_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SimulateSpecialResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
